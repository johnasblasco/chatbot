...
const Chatbot = () => {
    ...
    return (
        <div className={`fixed bottom-6 right-6 transition-all duration-300 ease-in-out z-50 ${isHalfSize ? 'w-92 h-[500px]' : 'w-full h-full max-w-4xl max-h-[600px]'
            } ${isMinimized ? 'h-16' : ''}`}>
            <div className="ml-2 bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl w-[95vw] h-full flex flex-col border border-gray-200/50 overflow-hidden">
